...
# Application
An application built from https://github.com/jdubrick-ai/apr8-audio will be stored in [quay.io/jdubrick-ai/apr8-audio](https://quay.io/jdubrick-ai/apr8-audio) and deployed through GitOps. This application is accessible on port **8501**.